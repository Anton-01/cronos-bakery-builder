...
export function useFormValidation<TFields extends Record<string, FieldConfig<unknown>>>(fieldConfigs: TFields) {
    ...
    return { form: form as FormValues,
        touched, isValid, validateAll, validateField,
        fieldError, fieldHasError, handleServerErrors,
        reset, onBlur, onInput,
    }
}
